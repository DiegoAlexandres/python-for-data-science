...
#%%
# Renomeando todas as colunas do dataframe -  Precisa passar todas as colunas
df_rh.columns = ["Id_Empregado", "Nome_Novo",  "Departamento_Novo"]
df_rh
...
#%%
# Juntando uma coluna ('Id_Funcionario') com um índice ('ID_Empregado')
